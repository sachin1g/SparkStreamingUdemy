...
object LogSQL {
  ...
  def main(args: Array[String]) {
    ...
    val conf = new SparkConf().setAppName("LogSQL").setMaster("local[*]").set("spark.sql.warehouse.dir", "file:///C:/Users/Sherlocke/Desktop/Intellij")
    ...
    requests.foreachRDD((rdd, time) => {
      ...
      println(s"========= $time =========")
      println("Storing DF to FS")
      wordCountsDataFrame.write.mode("append").json("LogSql")
